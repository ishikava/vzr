var $jscomp = {
    scope: {}, findInternal: function (t, a, e) {
        for (var n = (t = t instanceof String ? String(t) : t).length, s = 0; s < n; s++) {
            var r = t[s];
...
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, a, e) {
    ...
    function i(c, y, M) {
        var b = {
            invalid: [], getCaret: function () {
                try {
                    var t = 0, a = c.get(0), e = document.selection, a = a.selectionStart;
                    return e && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((e = e.createRange()).moveStart("character", -b.val().length), t = e.text.length) : !a && "0" !== a || (t = a), t
                } catch (t) {
                }
            }, setCaret: function (t) {
                try {
                    var a;
                    c.is(":focus") && ((a = c.get(0)).setSelectionRange ? a.setSelectionRange(t, t) : ((a = a.createTextRange()).collapse(!0), a.moveEnd("character", t), a.moveStart("character", t), a.select()))
                } catch (t) {
                }
            }, events: function () {
                ...
                var t = c.data("mask-previus-value") || "", a = b.getMasked(), e = b.getCaret();
                if (t !== a) {
                    for (var n = c.data("mask-previus-caret-pos") || 0, a = a.length, s = t.length, r = t = 0, o = 0, i = 0, l = e; l < a && b.maskDigitPosMap[l]; l++) r++;
                    for (l = e - 1; 0 <= l && b.maskDigitPosMap[l]; l--) t++;
                    for (l = e - 1; 0 <= l; l--) b.maskDigitPosMap[l] && o++;
                    for (l = n - 1; 0 <= l; l--) b.maskDigitPosMapOld[l] && i++;
                    s < e ? e = 10 * a : e <= n && n !== s ? b.maskDigitPosMapOld[e] || (e = (n = e) - (i - o) - t, b.maskDigitPosMap[e] && (e = n)) : n < e && (e = e + (o - i) + r)
                }
                return e
                ...
                if (-1 === o.inArray(a, j.byPassKeys)) {
                    var a = b.getMasked(), e = b.getCaret();
                ...
                for (var e, n, s = [], r = void 0 === a ? b.val() : a + "", o = 0, i = y.length, l = 0, c = r.length, u = 1, p = "push", f = -1, d = 0, k = [], h = M.reverse ? (p = "unshift", u = -1, e = 0, o = i - 1, l = c - 1, function () {
                    return -1 < o && -1 < l
                }) : (e = i - 1, function () {
                    return o < i && l < c
                }); h();) {
                    var v = y.charAt(o), g = r.charAt(l), m = j.translation[v];
                    m ? (g.match(m.pattern) ? (s[p](g), m.recursive && (-1 === f ? f = o : o === e && o !== f && (o = f - u), e === f && (o -= u)), o += u) : g === n ? (d--, n = void 0) : m.optional ? (o += u, l -= u) : m.fallback ? (s[p](m.fallback), o += u, l -= u) : b.invalid.push({
                        p: l,
                        v: g,
                        e: m.pattern
                    }), l += u) : (t || s[p](v), g === v ? (k.push(l), l += u) : (n = v, k.push(l + d), d++), o += u)
                }
                return r = y.charAt(e), i !== c + 1 || j.translation[r] || s.push(r), s = s.join(""), b.mapMaskdigitPositions(s, k, c), s
        ...
        y = "function" == typeof y ? y(b.val(), void 0, c, M) : y, j.mask = y, j.options = M, j.remove = function () {
            ...
            if (t = t || !1, M = M || {}, j.clearIfNotMatch = o.jMaskGlobals.clearIfNotMatch, j.byPassKeys = o.jMaskGlobals.byPassKeys, j.translation = o.extend({}, o.jMaskGlobals.translation, M.translation), j = o.extend(!0, {}, j, M), n = b.getRegexMask(), t) b.events(), b.val(b.getMasked()); else {
    ...
    function a() {
        var t = o(this), a = {}, e = t.attr("data-mask");
    ...
    var l = function (t, a, e) {
        e = e || {};
        var n = o(t).data("mask"), s = JSON.stringify;
        t = o(t).val() || o(t).text();
        try {
    ...
    o.fn.mask = function (t, a) {
        ...
        var n = this.selector, s = (r = o.jMaskGlobals).watchInterval, r = a.watchInputs || r.watchInputs;
